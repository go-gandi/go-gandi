...
func (g *LiveDNSAPI) GetDomainRecords(fqdn string) (records []DomainRecord, err error) {
...
func (g *LiveDNSAPI) GetDomainRecordsAsText(uuid string) ([]byte, error) {
...
func (g *LiveDNSAPI) GetDomainRecordsByName(fqdn, name string) (records []DomainRecord, err error) {
...
func (g *LiveDNSAPI) GetDomainRecordByNameAndType(fqdn, name, recordtype string) (record DomainRecord, err error) {
...
func (g *LiveDNSAPI) CreateDomainRecord(fqdn, name, recordtype string, ttl int, values []string) (response types.StandardResponse, err error) {
...
func (g *LiveDNSAPI) UpdateDomainRecords(fqdn string, records []DomainRecord) (response types.StandardResponse, err error) {
...
func (g *LiveDNSAPI) UpdateDomainRecordsByName(fqdn, name string, records []DomainRecord) (response types.StandardResponse, err error) {
	prefixedRecords := itemsPrefixForZoneRecords{Items: records}
...
func (g *LiveDNSAPI) UpdateDomainRecordByNameAndType(fqdn, name, recordtype string, ttl int, values []string) (response types.StandardResponse, err error) {
...
func (g *LiveDNSAPI) DeleteAllDomainRecords(fqdn string) (err error) {
...
func (g *LiveDNSAPI) DeleteDomainRecordsByName(fqdn, name string) (err error) {
...
func (g *LiveDNSAPI) DeleteDomainRecord(fqdn, name, recordtype string) (err error) {
