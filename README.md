...
// Step 8: Create a TSIG key
g.CreateTsig()
//Step 9: Add the TSIG key to the domain
g.AddTsigToDomain("example.com", "85e7b6e3-4553-479b-b968-cd0c77143802")
//Step 10: Get the nameservers which provide axfr services for that TSIG key in the BIND config example
